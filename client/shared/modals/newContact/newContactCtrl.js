    ...
    Contact.create($scope.data.thisRecord).$promise
      .then(function(results){
                    ...
                    _.forEach($scope.data.selectedOwners, function(owner){
                        allPromises.push(Contact.owners.create(
                            {"id": thisRecord.id},
                            {
                    ...
                    _.forEach($scope.data.related, function(value){
                       ...
                       //push in promise
                       allPromises.push(
                        RelationshipManager.linkEntity(thisRecord, value, "Contact", value.thisEntityType, 
                              {
                                "from": {
                    ...
                    return $q.allLimit(1, allPromises)
                      .then(function(data) {
                         Logger.info('Contact Created Succesfully');
