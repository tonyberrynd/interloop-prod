...
angular.module('interloop.companyEditCtrl', [])
...
function activate(){
	...
	return Company.findOne({"filter": {"where": {"id": $stateParams.id}}}).$promise	
...
//===========================================
	...
	*/
	function returnToDetails(){
		$state.go('app.company-details', {id: $stateParams.id })
	}



	function save(noAlert){
		 return Company.prototype$patchAttributes({"id": $scope.data.thisRecord.id}, $scope.data.thisRecord).$promise
