...
function activate() {
                ...
                return gridManager.initGrid('Activity', $scope.data.thisView)
                  .then(function(results){
                    ...
                    $timeout(function(){
                      ...
                      if(oppId) {
                        //open sidebar
                        SidebarRouter.openTo('Activity', oppId)
                      }
  ...
  .catch(function(err){
    ...
    $state.go('app.activities', {viewId: 'default'});
  })
}
//-------------------------------------------
activate();
...
function bulkCreateView(){
    ...
    //creates static view that only includes these particular activities
...
function changeView(view) {
  ...
  // change view
  $state.go('app.activities', {"viewId": view.id}, {reload: 'app.activities'});
}
